...
/*8. Exclusive OR (XOR). Show the countries that are big by area or big by population 
...
SELECT name, (ROUND(gdp/population, -3)) AS 'per-capital GDP' 
...
SELECT name 
FROM world 
WHERE name NOT LIKE '% %' AND name LIKE '%e%' AND  name LIKE '%a%'  
