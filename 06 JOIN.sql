...
/*1. show the matchid and player name for all goals scored by Germany. To identify German 
...
/*4. Show the team1, team2 and player for every goal scored by a player called Mario player 
LIKE 'Mario%'*/
...
/*6. List the the dates of the matches and the name of the team in which 'Fernando Santos' 
was the team1 coach.*/
